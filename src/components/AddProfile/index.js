    ...
    <div className={styles["add-profile"]}>
      ...
      <form className={styles["user-detail"]}>
        <div className={styles["form-group"]}>
          ...
          <input type="text" value={""} placeholder="Please Enter Fullname" id="edit-fullname-id"/>
        </div>
        <div className={styles["form-group"]}>
          <label for="edit-height-id">Height (cm.)</label>
          <FaRuler className={styles["icon"]}  style={{color:"#ffffffd9"}} />
          <input type="text" value={""} placeholder="Please Enter Height (cm.)" id="edit-height-id"/>
        </div>
        <div className={styles["form-group"]}>
        ...
        <div className={styles["form-group"]}>
          ...
          <input type="text" value={""} placeholder="Please Enter Weight (kg.)" id="edit-weight-id"/>
        </div>
        <div className={styles["form-group"]}>
          <label for="edit-age-id">Date Of Birth</label>
          <FaCalendarAlt className={styles["icon"]}  style={{color:"#ffffffd9"}} />
          <input type="date" value={""} placeholder="Please Select Date Of Birth" id="edit-age-id"/>
          <span>age</span>
        </div>
        <div className={styles["form-group"]}>
          <label for="edit-goal-id">My Goal (Days)</label>
          <FaBullseye className={styles["icon"]}  style={{color:"#ffffffd9"}} />
          <input type="text" value={""} placeholder="Please Enter Goals (Days)" id="edit-goal-id"/>
        </div>
